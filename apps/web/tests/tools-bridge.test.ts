...
function deps(over: Partial<BridgeDeps> = {}): BridgeDeps {
  ...
  const base = {
    ...
    queryRecords: forbidden('queryRecords'),
    getRecord: forbidden('getRecord'),
    setFields: forbidden('setFields'),
    referencesFor: forbidden('referencesFor'),
    resourceViewer: forbidden('resourceViewer'),
    listResources: forbidden('listResources'),
    loadView: forbidden('loadView'),
    requireVisibleResource: forbidden('requireVisibleResource'),
    readResourceText: forbidden('readResourceText'),
    resourceBlob: forbidden('resourceBlob'),
    tenantArgDenial: forbidden('tenantArgDenial'),
