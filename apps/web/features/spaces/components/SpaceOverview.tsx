...
/**
 * A live space's page — one page, two modes. Rendered by /spaces/<id> and
 * by the space's node page, under its Page · Context tabs. Non-members get the pitch (about,
...
export default function SpaceOverview({ spaceId }: { spaceId: string }) {
