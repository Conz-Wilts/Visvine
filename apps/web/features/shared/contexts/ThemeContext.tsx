...
function applyAll(theme: ColorTheme) {
  ...
  // Shell chrome. Navbar and rail are plain white and meet the content with no
  // seam: --shell-border stays transparent so nothing frames the page.
