/**
 * contextLayout.ts — a self-contained context layout engine.
 *
...
function connectedComponents(g: PreparedContext): Int32Array {
...
function buildComponents(g: PreparedContext, roots: Int32Array): Component[] {
