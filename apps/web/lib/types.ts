...
// `import` = bulk-loaded curated data. See docs/link-management-design.md.
...
// overrides these via `linkTypes`; this is the seeded fallback. The three
// `system` types back the auto-link flows (RSVP/event/intro) and must always
// resolve, even before a community config loads. Keep in sync with the
// `Community.linkTypes` default in schema.prisma.
