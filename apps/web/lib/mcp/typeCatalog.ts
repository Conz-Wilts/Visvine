...
const GUIDANCE: Record<string, string> = {
  ...
  tool: 'A Tool — an app a member builds, note-first and folder-only: the member authors tools/<name>/index.md (frontmatter declares its surfaces and the perimeter of context it may touch; body = docs) beside tools/<name>/ui.md and tools/<name>/data.md, which hold its source. Never creatable via add_context (tools/ is frozen for AI — a human authors tools); admins install and publish one from the Tools marketplace.',
