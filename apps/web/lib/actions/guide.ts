...
const NOTE_FIRST = [
  ...
  'note IS the thing — not a description of a record stored elsewhere. A connector is the note declaring `type: connector` — written as `connectors/<name>.md`, and an admin may file it in a folder of the space\'s own.',
