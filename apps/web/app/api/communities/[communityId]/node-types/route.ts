// Community-wide node type vocabulary. Any active member may add a type when
...
// community record, which is what keeps it out of the admin-only PUT.
...
export async function PATCH(
  ...
  const merged = mergeNodeType(community.nodeTypes as NodeTypeConfig[] | null, { name, color });
