...
//   node scripts/import-notes-vault.mjs --space blackbird-ventures --vault <dir> [--scope shared|personal] [--owner <userId>] [--created-by <userId>]
//   pnpm db:notes-vault -- --space blackbird-ventures --vault ../vault
//
