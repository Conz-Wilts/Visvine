...
//   node scripts/import-notes-vault.mjs --space community:visvine-hq --vault <dir> [--scope shared|personal] [--owner <userId>] [--created-by <userId>]
//   pnpm db:notes-vault -- --space community:visvine-hq --vault ../vault
//
