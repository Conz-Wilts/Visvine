import { BRAND_GREEN, NODE_GLYPH_PATHS, type NodeGlyph } from '@/lib/avatarUtils';
 ...
 */
export default function TypeSilhouette({ glyph, color = BRAND_GREEN, className = '' }: TypeSilhouetteProps) {
  return (
    <div
