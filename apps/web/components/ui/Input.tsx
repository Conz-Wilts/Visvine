 ...
 * the fill lifts to `surface-1` inside a single hairline ring in the ink
...
export const inputBaseClass =
  'w-full rounded-lg bg-surface-2 px-4 py-3 text-base ' +
  'text-text-primary placeholder:text-text-muted transition-colors ' +
  'focus:bg-surface-1 focus:outline-none focus:ring-1 focus:ring-border-default ' +
