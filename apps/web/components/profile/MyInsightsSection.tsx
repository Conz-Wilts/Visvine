      ...
      <div className="px-6 sm:px-8 pb-8">
        <div className="bg-surface-2/50 border border-border-subtle rounded-xl p-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-text-primary">My Insights</h3>
            <span className="text-xs text-text-muted bg-surface-3 px-2 py-0.5 rounded-full">Only visible to you</span>
          </div>
