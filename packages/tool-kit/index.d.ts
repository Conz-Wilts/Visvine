...
export type IconName = "arrow-down" | "arrow-left" | "arrow-right" | "arrow-up" | "at-sign" | "ban" | "bell" | "bird" | "blocks" | "bold" | "book-open" | "bookmark" | "bot" | "brain" | "briefcase" | "bug" | "building" | "calendar-check" | "calendar-plus" | "calendar" | "camera" | "check" | "chevron-down" | "chevron-left" | "chevron-right" | "chevron-up" | "chevrons-up-down" | "circle-arrow-up" | "circle-check" | "circle-question-mark" | "clipboard-list" | "clock" | "code" | "coffee" | "coins" | "compass" | "copy" | "dollar-sign" | "download" | "earth" | "ellipsis" | "external-link" | "eye-off" | "eye" | "feed" | "file-archive" | "file-code-2" | "file-down" | "file-image" | "file-music" | "file-pdf" | "file-play" | "file-spreadsheet" | "file-text" | "file" | "flag" | "flame" | "folder-input" | "folder-open" | "folder" | "gamepad-2" | "git-pull-request" | "globe" | "grip-vertical" | "hammer" | "hand" | "handshake" | "hash" | "heart" | "house" | "image-plus" | "image" | "inbox" | "info" | "italic" | "key-round" | "layout-grid" | "lightbulb" | "link-2-off" | "link-2" | "linkedin" | "list-filter" | "list-ordered" | "list" | "loader-circle" | "lock-open" | "lock" | "log-out" | "mail" | "map-pin" | "maximize-2" | "megaphone" | "message-circle" | "message-square" | "mic" | "minimize-2" | "minus" | "moon" | "music" | "nav-agents" | "nav-channels" | "nav-connectors" | "nav-context" | "nav-directory" | "nav-events" | "nav-resources" | "nav-tools" | "network" | "newspaper" | "package" | "palette" | "panel-right" | "party-popper" | "pencil" | "phone" | "pin" | "pizza" | "play" | "plug" | "plus" | "presentation" | "radio" | "refresh-cw" | "reply" | "rocket" | "rotate-ccw" | "rotate-cw" | "search" | "send" | "settings-2" | "settings" | "share-2" | "share" | "shield-check" | "smile" | "space" | "sparkles" | "sprout" | "square-check" | "square" | "star" | "sun" | "table" | "tag" | "target" | "text-quote" | "tool-calendar" | "tool-chart" | "tool-folder" | "tool-grid" | "tool-kanban" | "tool-list" | "tool-note" | "tool-people" | "tool-sparkle" | "tool-table" | "trash-2" | "trending-up" | "triangle-alert" | "trophy" | "twitter" | "type" | "upload" | "user-check" | "user-plus" | "user" | "users-round" | "users" | "video" | "vote" | "waypoints" | "x" | "zap" | "zoom-in" | "zoom-out" | "filter" | "trash" | "edit" | "dollar" | "chart" | "trend" | "board" | "link" | "message" | "box" | "bolt" | "book" | "home" | "arrowRight" | "arrowUp" | "arrowDown" | "chevronLeft" | "chevronRight" | "more"
